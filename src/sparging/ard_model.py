...
import yaml
import sparging.config as helpers
import json
...
class SimulationResults:
    ...
    def validity_record(self, sample: dict | None = None, **kwargs) -> dict:
        ...
        e_SPP = ((tau_fitted - tau_pred_SPP) / tau_pred_SPP).to("dimensionless")
        ...
        record = {
            ...
            "tau_pred_SPP_s": _si(tau_pred_SPP, "s"),
