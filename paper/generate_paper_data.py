...
OUT_DIR = Path("paper/runs/convergence_study_2")
...
Output is written to ``paper/runs/analytical_validity/``.
"""

OUT_DIR_VALIDITY = Path("paper/runs/analytical_validity")
...
Output is written to ``paper/runs/factorial_study/``.
"""

OUT_DIR_FACT = Path("paper/runs/factorial_study")
...
Output is written to ``paper/runs/analytical_validity2/``.
"""

OUT_DIR_AV2 = Path("paper/runs/analytical_validity2")
...
Output is written to ``paper/runs/non_exponential/``.
"""

OUT_DIR_NONEXP = Path("paper/runs/non_exponential")
...
Output is written to ``paper/runs/verification_case/<variant>/``.
"""

OUT_DIR_VERIF = Path("paper/runs/verification_case")
